...
public class TradeCollector6Test
{
    ...
    public void testMovingAverageTradesSeveralPortfolio() throws TradeCollectorException
    {
        ...
        var p2 = new PortfolioBuilder(new Account("two")).buyPrice(security, "2022-02-02", 5, 200).addTo(client);
        ...
        var snapshot = LazySecurityPerformanceSnapshot.create(new PortfolioClientFilter(p2).filter(client),
