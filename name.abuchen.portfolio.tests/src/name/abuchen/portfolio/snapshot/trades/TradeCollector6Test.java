...
public class TradeCollector6Test
{
    ...
    public void testTradesSeveralPortfolio() throws TradeCollectorException
    {
        ...
        assertThat(fourthTrade.getStart(), is(LocalDateTime.parse("2022-01-02T00:00")));
    ...
    public void testTradesSeveralPortfolio2() throws TradeCollectorException
    {
        ...
        Trade newTrade = trades.get(2);
        assertThat(newTrade.getEnd().isPresent(), is(true));

        // 1480 - (2000 * 5/10) = 480
        assertThat(newTrade.getProfitLoss(), is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(480.00))));
        // 1480 - (1000 + 2000) * 5/15 = 480
        assertThat(newTrade.getProfitLossMovingAverage(),
                        is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(480))));

        // 1480+10+10 - (2000 * 5/10) = 500
        assertThat(newTrade.getProfitLossWithoutTaxesAndFees(),
