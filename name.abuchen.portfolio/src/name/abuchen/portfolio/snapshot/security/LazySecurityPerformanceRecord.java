                ...
                implements Adaptable, TrailProvider
{
    ...
    /**
     * moving average cost of shares held without fees
     */
    private final LazyValue<Money> movingAverageCostGross = new LazyValue<>(
    ...
    public LazyValue<Money> getMovingAverageCostGross()
    {
        return movingAverageCostGross;
    }
