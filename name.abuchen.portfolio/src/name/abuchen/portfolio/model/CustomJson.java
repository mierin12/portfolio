...
public class CustomJson implements Comparable<CustomJson>
{
    ...
    public CustomJson(String pattern)
    {
        this(pattern, pattern);
    }

    public CustomJson(String label, String pattern)
    {
        this.label = Objects.requireNonNull(label);
        this.pattern = Objects.requireNonNull(pattern);
    }

    public CustomJson(String label, String pattern, String pathToDate, String pathToClose)
    {
        this.label = Objects.requireNonNull(label);
        this.pattern = Objects.requireNonNull(pattern);
        this.pathToDate = Objects.requireNonNull(pathToDate);
        this.pathToClose = Objects.requireNonNull(pathToClose);
    }
    ...
    public void setPathToDate(String pathToDate)
    {
        this.pathToDate = pathToDate;
    }

    public String getPathToDate()
    {
        return pathToDate;
    }

    public void setpathToClose(String pathToClose)
    {
        this.pathToClose = pathToClose;
    }

    public String getpathToClose()
    {
        return pathToClose;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        CustomJson other = (CustomJson) obj;
    ...
    @Override
    public int compareTo(CustomJson other)
    {
