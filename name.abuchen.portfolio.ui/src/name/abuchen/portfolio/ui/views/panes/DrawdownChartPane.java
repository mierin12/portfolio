...
import name.abuchen.portfolio.ui.views.DrawdownChart;
...
public class DrawdownChartPane implements InformationPanePage
{
    @Inject
    ...
    public Control createViewControl(Composite parent)
    {
        ...
        chart = new DrawdownChart(sash, client, new CurrencyConverterImpl(factory, client.getBaseCurrency()));

        String option = preferences.getString(DrawdownChartPane.class.getSimpleName());
        ...
        chart.getControl().addDisposeListener(e -> preferences.setValue(DrawdownChartPane.class.getSimpleName(),
